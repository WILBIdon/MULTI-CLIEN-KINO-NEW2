    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="<?= $baseUrl ?? '' ?>index.php" class="nav-item <?= $currentModule === 'gestor' ? 'active' : '' ?>"
                ...
                <span class="nav-label">Dashboard Principal</span>
            </a>

            <a href="<?= $baseUrl ?? '' ?>modules/busqueda/"
                class="nav-item <?= $currentModule === 'busqueda' ? 'active' : '' ?>" data-tooltip="Búsqueda Avanzada">
                <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="nav-label">Búsqueda Avanzada</span>
            </a>
